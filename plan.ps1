...
$pkg_filename="xwebwdministration.2.7.0.nupkg"
$pkg_shasum=""
$pkg_bin_dirs=@("bin")
$pkg_build_deps=@("core/nuget")

function Invoke-Unpack { 
  New-Item -ItemType Directory -Path $HAB_CACHE_SRC_PATH/outputn -Force
...
function Invoke-Install {
  Copy-Item "$HAB_CACHE_SRC_PATH/output/xWebAdministration.2.7.0.0/*" "$pkg_prefix/bin" -Force -Recurse
}
